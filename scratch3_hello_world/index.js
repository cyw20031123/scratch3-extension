...
class Scratch3HelloBlocks {
    constructor(runtime) {
        ...
        this.peripheral = new MicroBit(this.runtime, Scratch3MicroBitBlocks.EXTENSION_ID);
    }
            ...
            blocks: [
                ...
                },
                {
                    ...
                    text: formatMessage({
                        id: 'helloWorld.jump',
                        default: 'jump [TEXT]',
                        description: 'jump HowHigh'
                    }),
                    arguments: {
                        TEXT: {
                            type: ArgumentType.NUMBER,
                            defaultValue: formatMessage({
                                id: 'helloWorld.HowHighDoYouJump',
                                default: 1,
                                description: 'How high do you jump.'
                            })
                        }
                    }
                },
